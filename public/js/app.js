...
/** Animated worm shown faintly in the background of the chat columns —
 *  always visible, behind the content. */
function pulseBackground() {
  return el('div', { class: 'bg-pulse', 'aria-hidden': 'true' }, [
    el('div', { class: 'bg-pulse-stage' }, [
      el('div', { class: 'bg-pulse-rings' }, [
        el('span', { class: 'bg-pulse-ring' }),
        el('span', { class: 'bg-pulse-ring' }),
        el('span', { class: 'bg-pulse-ring' }),
      ]),
      el('img', { class: 'bg-pulse-logo', src: '/assets/logo.svg', alt: '' }),
      el('div', {
        class: 'bg-pulse-ekg',
        html:
          '<svg viewBox="0 0 240 48" width="200" height="36" aria-hidden="true">' +
          '<path class="bg-pulse-ekg-path" d="M0 24 H64 L74 24 L80 10 L88 38 L94 24 H126 L134 24 L140 12 L148 36 L154 24 H240"/>' +
          '</svg>',
      }),
    ]),
  ]);
